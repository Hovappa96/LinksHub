      ...
      >
        ...
        <div className="flex items-center gap-3 px-4 border-b border-gray-200 dark:border-gray-700">
          ...
          <input
            ref={inputRef}
            type="text"
            className="w-full py-4 bg-transparent outline-none text-gray-900 dark:text-gray-100 placeholder-gray-400"
          ...
          {query.trim() !== '' && (
            <div className="space-y-1">
              ...
              >
                ...
                {selected === 0 && (
                  <kbd className="px-1.5 py-0.5 text-xs bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-400 rounded border border-gray-300 dark:border-gray-600">
                    ↵
                  </kbd>
                )}
              </button>
              ...
              {results.length === 0 && (
                <div className="px-4 py-8 text-center text-gray-500 dark:text-gray-400">
                  No quick links found. Press Enter to search all resources.
                </div>
              )}
            </div>
          )}
